...
if (!isset($stats)) { 
    $stats = ['total_vagas' => 0, 'lojas_ativas' => 0, 'valor_gasto' => 0]; 
}
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <div class="container" style="padding: 40px 20px;">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card lojas">
                ...
                <div class="stat-card-info">
                    <div class="stat-number"><?= $stats['lojas_ativas'] ?></div>
             ...
             <div class="stat-card operadores">
                ...
                <div class="stat-card-info">
                    <div class="stat-number">R$ <?= number_format($stats['valor_gasto'], 2, ',', '.') ?></div>
