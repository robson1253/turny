...
<head>
    ...
    <style>
        ...
        .progress-step.active::before { background-color: var(--cor-primaria); }
        .progress-step.active ~ .progress-step::after { background-color: #ccc; }
        .progress-step.active ~ .progress-step::before { background-color: #ccc; }
    ...
    <div class="operador-container">
        ...
        <form action="/registro/operador" method="POST" class="form-panel" id="register-form" enctype="multipart/form-data" style="border: none; box-shadow: none; padding: 20px 30px;">
            ...
            <fieldset class="form-step">
                ...
                <div class="form-group"><label for="doc_frente">Frente do Documento (RG ou CNH)</label><input type="file" id="doc_frente" name="doc_frente" accept="image/*" capture="environment" required></div>
                <div class="form-group"><label for="doc_verso">Verso do Documento (se aplicável)</label><input type="file" id="doc_verso" name="doc_verso" accept="image/*" capture="environment"></div>
